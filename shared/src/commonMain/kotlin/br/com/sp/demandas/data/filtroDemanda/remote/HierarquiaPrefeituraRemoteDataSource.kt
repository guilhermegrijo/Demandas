...
class HierarquiaPrefeituraRemoteDataSource (
    private val httpClient: HttpClient,
    private val userSettings: AuthCredentials
) {

    suspend fun getHierarquiaPrefeitura(idPrefeitura: Int): ApiResponse<List<FiltroResponse>, ErrorResponse> =
        httpClient.safeRequest {
            url {
                method = HttpMethod.Get
                path("api/v1.0/Hierarquia/GetComboPrefeitura/${idPrefeitura}")
